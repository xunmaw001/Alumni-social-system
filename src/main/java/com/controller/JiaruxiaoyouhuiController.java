...
public class JiaruxiaoyouhuiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiaruxiaoyouhuiEntity jiaruxiaoyouhui,
		...
		if(tableName.equals("yonghu")) {
			jiaruxiaoyouhui.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JiaruxiaoyouhuiEntity> wrapper = new EntityWrapper<JiaruxiaoyouhuiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jiaruxiaoyouhuiService.selectCount(wrapper);
